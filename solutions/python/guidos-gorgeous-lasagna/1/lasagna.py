...
def bake_time_remaining(elapsed_bake_time):
    ...
    This function returns how many minutes the lasagna still needs to bake
...
def preparation_time_in_minutes(number_of_layers):
    ...
    Each layer takes a fixed amount of time defined by PREPARATION_TIME.
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    This function adds preparation time and baking time.
    """
